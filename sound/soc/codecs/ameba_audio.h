...
#define AUD_MASK_PDM_CH_SWAP                 ((u32)0x00000003 << 7)          /*!<R/W 2  pdm_ch_swap */
...
#define AUD_MASK_ANA_CLK_RATE_SEL            ((u32)0x00000003 << 4)          /*!<R/W 0  Set DA/AD analog clock 0: 10MHz 1: 5MHz 2: 2.5MHz 3: Reseved */
#define AUD_ANA_CLK_RATE_SEL(x)              ((u32)(((x) & 0x00000003) << 4))
#define AUD_GET_ANA_CLK_RATE_SEL(x)          ((u32)(((x >> 4) & 0x00000003)))
#define AUD_MASK_AD_LPF_CLK_RATE_SEL         ((u32)0x00000003 << 6)          /*!<R/W 0  Set AD LPF clock 0: 10MHz 1: 5MHz 2: 2.5MHz 3: Reseved */
#define AUD_AD_LPF_CLK_RATE_SEL(x)           ((u32)(((x) & 0x00000003) << 6))
#define AUD_GET_AD_LPF_CLK_RATE_SEL(x)       ((u32)(((x >> 6) & 0x00000003)))
#define AUD_MASK_ADC_0_DMIC_LPF_CLK_SEL      ((u32)0x00000003 << 8)          /*!<R/W 0  Channel 0 ADC path DMIC LPF clock 2'b00: 10M 2'b01: 5M 2'b10: 2.5M 2'b11: 769.2*2K */
#define AUD_ADC_0_DMIC_LPF_CLK_SEL(x)        ((u32)(((x) & 0x00000003) << 8))
#define AUD_GET_ADC_0_DMIC_LPF_CLK_SEL(x)    ((u32)(((x >> 8) & 0x00000003)))
#define AUD_MASK_ADC_1_DMIC_LPF_CLK_SEL      ((u32)0x00000003 << 10)          /*!<R/W 0  Channel 1 ADC path DMIC LPF clock 2'b00: 10M 2'b01: 5M 2'b10: 2.5M 2'b11: 769.2*2K */
#define AUD_ADC_1_DMIC_LPF_CLK_SEL(x)        ((u32)(((x) & 0x00000003) << 10))
#define AUD_GET_ADC_1_DMIC_LPF_CLK_SEL(x)    ((u32)(((x >> 10) & 0x00000003)))
#define AUD_MASK_ADC_2_DMIC_LPF_CLK_SEL      ((u32)0x00000003 << 12)          /*!<R/W 0  Channel 2 ADC path DMIC LPF clock 2'b00: 10M 2'b01: 5M 2'b10: 2.5M 2'b11: 769.2*2K */
#define AUD_ADC_2_DMIC_LPF_CLK_SEL(x)        ((u32)(((x) & 0x00000003) << 12))
#define AUD_GET_ADC_2_DMIC_LPF_CLK_SEL(x)    ((u32)(((x >> 12) & 0x00000003)))
#define AUD_MASK_ADC_3_DMIC_LPF_CLK_SEL      ((u32)0x00000003 << 14)          /*!<R/W 0  Channel 3 ADC path DMIC LPF clock 2'b00: 10M 2'b01: 5M 2'b10: 2.5M 2'b11: 769.2*2K */
#define AUD_ADC_3_DMIC_LPF_CLK_SEL(x)        ((u32)(((x) & 0x00000003) << 14))
#define AUD_GET_ADC_3_DMIC_LPF_CLK_SEL(x)    ((u32)(((x >> 14) & 0x00000003)))
#define AUD_MASK_ADC_4_DMIC_LPF_CLK_SEL      ((u32)0x00000003 << 16)          /*!<R/W 0  Channel 4 ADC path DMIC LPF clock 2'b00: 10M 2'b01: 5M 2'b10: 2.5M 2'b11: 769.2*2K */
#define AUD_ADC_4_DMIC_LPF_CLK_SEL(x)        ((u32)(((x) & 0x00000003) << 16))
#define AUD_GET_ADC_4_DMIC_LPF_CLK_SEL(x)    ((u32)(((x >> 16) & 0x00000003)))
#define AUD_MASK_ADC_5_DMIC_LPF_CLK_SEL      ((u32)0x00000003 << 18)          /*!<R/W 0  Channel 5 ADC path DMIC LPF clock 2'b00: 10M 2'b01: 5M 2'b10: 2.5M 2'b11: 769.2*2K */
#define AUD_ADC_5_DMIC_LPF_CLK_SEL(x)        ((u32)(((x) & 0x00000003) << 18))
#define AUD_GET_ADC_5_DMIC_LPF_CLK_SEL(x)    ((u32)(((x >> 18) & 0x00000003)))
#define AUD_MASK_ADC_6_DMIC_LPF_CLK_SEL      ((u32)0x00000003 << 20)          /*!<R/W 0  Channel 6 ADC path DMIC LPF clock 2'b00: 10M 2'b01: 5M 2'b10: 2.5M 2'b11: 769.2*2K */
#define AUD_ADC_6_DMIC_LPF_CLK_SEL(x)        ((u32)(((x) & 0x00000003) << 20))
#define AUD_GET_ADC_6_DMIC_LPF_CLK_SEL(x)    ((u32)(((x >> 20) & 0x00000003)))
#define AUD_MASK_ADC_7_DMIC_LPF_CLK_SEL      ((u32)0x00000003 << 22)          /*!<R/W 0  Channel 7 ADC path DMIC LPF clock 2'b00: 10M 2'b01: 5M 2'b10: 2.5M 2'b11: 769.2*2K */
#define AUD_ADC_7_DMIC_LPF_CLK_SEL(x)        ((u32)(((x) & 0x00000003) << 22))
#define AUD_GET_ADC_7_DMIC_LPF_CLK_SEL(x)    ((u32)(((x >> 22) & 0x00000003)))
/** @} */
...
#define AUD_MASK_ASRC_GAIN_SEL_TX            ((u32)0x00000003 << 2)          /*!<R/W 3  ASRC convergence rate: larger is faster but more noisy */
...
#define AUD_MASK_ASRC_GAIN_SEL_RX_0          ((u32)0x00000003 << 2)          /*!<R/W 3  ASRC convergence rate: larger is faster but more noisy */
...
#define AUD_MASK_ASRC_GAIN_SEL_RX_1          ((u32)0x00000003 << 2)          /*!<R/W 3  ASRC convergence rate: larger is faster but more noisy */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_I2S_1_DATA_CH0_SEL_RX       ((u32)0x00000007 << 0)          /*!<R/W 0x10  I2S 1 Rx channel data channel 0 0: CH0 1: CH1 2: CH2 3: CH3 4: CH4 5: CH5 6: CH6 7: CH7 */
#define AUD_I2S_1_DATA_CH0_SEL_RX(x)         ((u32)(((x) & 0x00000007) << 0))
#define AUD_GET_I2S_1_DATA_CH0_SEL_RX(x)     ((u32)(((x >> 0) & 0x00000007)))
#define AUD_MASK_I2S_1_DATA_CH1_SEL_RX       ((u32)0x00000007 << 3)          /*!<R/W 0x11  I2S 1 Rx channel data channel 1 0: CH0 1: CH1 2: CH2 3: CH3 4: CH4 5: CH5 6: CH6 7: CH7 */
...
#define AUD_MASK_I2S_1_DATA_CH4_SEL_RX       ((u32)0x00000007 << 12)          /*!<R/W 0x10  I2S 1 Rx channel data channel 4 0: CH0 1: CH1 2: CH2 3: CH3 4: CH4 5: CH5 6: CH6 7: CH7 */
#define AUD_I2S_1_DATA_CH4_SEL_RX(x)         ((u32)(((x) & 0x00000007) << 12))
#define AUD_GET_I2S_1_DATA_CH4_SEL_RX(x)     ((u32)(((x >> 12) & 0x00000007)))
#define AUD_MASK_I2S_1_DATA_CH5_SEL_RX       ((u32)0x00000007 << 15)          /*!<R/W 0x11  I2S 1 Rx channel data channel 5 0: CH0 1: CH1 2: CH2 3: CH3 4: CH4 5: CH5 6: CH6 7: CH7 */
...
#define AUD_MASK_ADC_0_AD_ZDET_FUNC          ((u32)0x00000003 << 16)          /*!<R/W 2  Channel 0 ADC path zero detection function select 2'b00: immediate change 2'b01: zero detection & immediate change 2'b10: zdet & step 2'b11: zdet & timeout step */
...
#define AUD_MASK_ADC_0_DCHPF_FC_SEL          ((u32)0x00000007 << 25)          /*!<R/W 5  Channel 0 ADC path High pass filter FC */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_0_AD_GAIN               ((u32)0x000000FF << 0)          /*!<R/W 2f  Channel 0 ADC digital volume -17.625dB ~ 48dB in 0.375dB step 8'h00: -17.625dB ... 8'h2f: 0dB 8'h30: 0.375dB ... 8'haf: 48dB */
...
#define AUD_MASK_ADC_1_AD_ZDET_FUNC          ((u32)0x00000003 << 16)          /*!<R/W 2  Channel 1 ADC path zero detection function select 2'b00: immediate change 2'b01: zero detection & immediate change 2'b10: zdet & step 2'b11: zdet & timeout step */
...
#define AUD_MASK_ADC_1_DCHPF_FC_SEL          ((u32)0x00000007 << 25)          /*!<R/W 5  Channel 1 ADC path High pass filter FC */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_1_AD_GAIN               ((u32)0x000000FF << 0)          /*!<R/W 2f  Channel 1 ADC digital volume -17.625dB ~ 48dB in 0.375dB step 8'h00: -17.625dB ... 8'h2f: 0dB 8'h30: 0.375dB ... 8'haf: 48dB */
...
#define AUD_MASK_ADC_2_AD_ZDET_FUNC          ((u32)0x00000003 << 16)          /*!<R/W 2  Channel 2 ADC path zero detection function select 2'b00: immediate change 2'b01: zero detection & immediate change 2'b10: zdet & step 2'b11: zdet & timeout step */
...
#define AUD_MASK_ADC_2_DCHPF_FC_SEL          ((u32)0x00000007 << 25)          /*!<R/W 5  Channel 2 ADC path High pass filter FC */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_2_AD_GAIN               ((u32)0x000000FF << 0)          /*!<R/W 2f  Channel 2 ADC digital volume -17.625dB ~ 48dB in 0.375dB step 8'h00: -17.625dB ... 8'h2f: 0dB 8'h30: 0.375dB ... 8'haf: 48dB */
...
#define AUD_MASK_ADC_3_AD_ZDET_FUNC          ((u32)0x00000003 << 16)          /*!<R/W 2  Channel 3 ADC path zero detection function select 2'b00: immediate change 2'b01: zero detection & immediate change 2'b10: zdet & step 2'b11: zdet & timeout step */
...
#define AUD_MASK_ADC_3_DCHPF_FC_SEL          ((u32)0x00000007 << 25)          /*!<R/W 5  Channel 3 ADC path High pass filter FC */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_3_AD_GAIN               ((u32)0x000000FF << 0)          /*!<R/W 2f  Channel 3 ADC digital volume -17.625dB ~ 48dB in 0.375dB step 8'h00: -17.625dB ... 8'h2f: 0dB 8'h30: 0.375dB ... 8'haf: 48dB */
...
#define AUD_MASK_ADC_4_AD_ZDET_FUNC          ((u32)0x00000003 << 16)          /*!<R/W 2  Channel 4 ADC path zero detection function select 2'b00: immediate change 2'b01: zero detection & immediate change 2'b10: zdet & step 2'b11: zdet & timeout step */
...
#define AUD_MASK_ADC_4_DCHPF_FC_SEL          ((u32)0x00000007 << 25)          /*!<R/W 5  Channel 4 ADC path High pass filter FC */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_4_AD_GAIN               ((u32)0x000000FF << 0)          /*!<R/W 2f  Channel 4 ADC digital volume -17.625dB ~ 48dB in 0.375dB step 8'h00: -17.625dB ... 8'h2f: 0dB 8'h30: 0.375dB ... 8'haf: 48dB */
...
#define AUD_MASK_ADC_5_AD_ZDET_FUNC          ((u32)0x00000003 << 16)          /*!<R/W 2  Channel 5 ADC path zero detection function select 2'b00: immediate change 2'b01: zero detection & immediate change 2'b10: zdet & step 2'b11: zdet & timeout step */
...
#define AUD_MASK_ADC_5_DCHPF_FC_SEL          ((u32)0x00000007 << 25)          /*!<R/W 5  Channel 5 ADC path High pass filter FC */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_5_AD_GAIN               ((u32)0x000000FF << 0)          /*!<R/W 2f  Channel 5 ADC digital volume -17.625dB ~ 48dB in 0.375dB step 8'h00: -17.625dB ... 8'h2f: 0dB 8'h30: 0.375dB ... 8'haf: 48dB */
...
#define AUD_MASK_ADC_6_AD_ZDET_FUNC          ((u32)0x00000003 << 16)          /*!<R/W 2  Channel 6 ADC path zero detection function select 2'b00: immediate change 2'b01: zero detection & immediate change 2'b10: zdet & step 2'b11: zdet & timeout step */
...
#define AUD_MASK_ADC_6_DCHPF_FC_SEL          ((u32)0x00000007 << 25)          /*!<R/W 5  Channel 6 ADC path High pass filter FC */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_6_AD_GAIN               ((u32)0x000000FF << 0)          /*!<R/W 2f  Channel 6 ADC digital volume -17.625dB ~ 48dB in 0.375dB step 8'h00: -17.625dB ... 8'h2f: 0dB 8'h30: 0.375dB ... 8'haf: 48dB */
...
#define AUD_MASK_ADC_7_AD_ZDET_FUNC          ((u32)0x00000003 << 16)          /*!<R/W 2  Channel 7 ADC path zero detection function select 2'b00: immediate change 2'b01: zero detection & immediate change 2'b10: zdet & step 2'b11: zdet & timeout step */
...
#define AUD_MASK_ADC_7_DCHPF_FC_SEL          ((u32)0x00000007 << 25)          /*!<R/W 5  Channel 7 ADC path High pass filter FC */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_7_AD_GAIN               ((u32)0x000000FF << 0)          /*!<R/W 2f  Channel 7 ADC digital volume -17.625dB ~ 48dB in 0.375dB step 8'h00: -17.625dB ... 8'h2f: 0dB 8'h30: 0.375dB ... 8'haf: 48dB */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_L_DA_GAIN               ((u32)0x000000FF << 0)          /*!<R/W af  Channel L DAC path dvol gain control (0.375dB/step) 8'hAF: 0dB 8'h00: -65.625dB */
...
#define AUD_MASK_DAC_L_TEST_FC_SEL           ((u32)0x0000007F << 21)          /*!<   Channel L DAC path test tone frquency: (fs/192)*(tone_fc_sel+1)Hz */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_L_DA_ZDET_FUNC          ((u32)0x00000003 << 0)          /*!<R/W 2  Channel L DAC path zero detection function select 2'b00: immediate change 2'b01: zero detection & immediate change 2'b10: zdet & step 2'b11: zdet & timeout step */
...
#define AUD_MASK_DAC_L_OB_GAIN               ((u32)0x0000000F << 20)          /*!<R/W 7  Channel L DAC path out Band tone gain -20dB - (6 * dac_l_ob_gain ) */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_R_DA_GAIN               ((u32)0x000000FF << 0)          /*!<R/W af  Channel R DAC path dvol gain control (0.375dB/step) 8'hAF: 0dB 8'h00: -65.625dB */
#define AUD_DAC_R_DA_GAIN(x)                 ((u32)(((x) & 0x000000FF) << 0))
#define AUD_GET_DAC_R_DA_GAIN(x)             ((u32)(((x >> 0) & 0x000000FF)))
#define AUD_MASK_DAC_R_DA_SRC_SEL            ((u32)0x00000003 << 16)          /*!<R/W 0  Channel R DAC path input select 0: I2S L channel 1: I2S R channel 2: I2S L+R channel 3: Test tone */
...
#define AUD_MASK_DAC_R_TEST_FC_SEL           ((u32)0x0000007F << 21)          /*!<R/W ox20  Channel R DAC path test tone frquency: (fs/192)*(tone_fc_sel+1)Hz */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_R_DA_ZDET_FUNC          ((u32)0x00000003 << 0)          /*!<R/W 2  Channel R DAC path zero detection function select 2'b00: immediate change 2'b01: zero detection & immediate change 2'b10: zdet & step 2'b11: zdet & timeout step */
...
#define AUD_MASK_DAC_R_OB_GAIN               ((u32)0x0000000F << 20)          /*!<R/W 7  Channel R DAC path out Band tone gain -20dB - (6 * dac_l_ob_gain ) */
...
#define AUD_MASK_ADC_0_SILENCE_DEBOUNCE_SEL  ((u32)0x00000007 << 4)          /*!<R/W 3  Channel 0 ADC path silence detection debounce (48K) 3'b000: 80ms 3'b001: 160ms 3'b010: 320ms 3'b011: 640ms 3'b100: 1.28s 3'b101: 2.56s 3'b110: 5.12s 3'b111: 0.16ms */
...
#define AUD_MASK_ADC_1_SILENCE_DEBOUNCE_SEL  ((u32)0x00000007 << 4)          /*!<R/W 3  Channel 1 ADC path silence detection debounce (48K) 3'b000: 80ms 3'b001: 160ms 3'b010: 320ms 3'b011: 640ms 3'b100: 1.28s 3'b101: 2.56s 3'b110: 5.12s 3'b111: 0.16ms */
...
#define AUD_MASK_ADC_2_SILENCE_DEBOUNCE_SEL  ((u32)0x00000007 << 4)          /*!<R/W 3  Channel 2 ADC path silence detection debounce (48K) 3'b000: 80ms 3'b001: 160ms 3'b010: 320ms 3'b011: 640ms 3'b100: 1.28s 3'b101: 2.56s 3'b110: 5.12s 3'b111: 0.16ms */
...
#define AUD_MASK_ADC_3_SILENCE_DEBOUNCE_SEL  ((u32)0x00000007 << 4)          /*!<R/W 3  Channel 3 ADC path silence detection debounce (48K) 3'b000: 80ms 3'b001: 160ms 3'b010: 320ms 3'b011: 640ms 3'b100: 1.28s 3'b101: 2.56s 3'b110: 5.12s 3'b111: 0.16ms */
...
#define AUD_MASK_ADC_4_SILENCE_DEBOUNCE_SEL  ((u32)0x00000007 << 4)          /*!<R/W 3  Channel 4 ADC path silence detection debounce (48K) 3'b000: 80ms 3'b001: 160ms 3'b010: 320ms 3'b011: 640ms 3'b100: 1.28s 3'b101: 2.56s 3'b110: 5.12s 3'b111: 0.16ms */
...
#define AUD_MASK_ADC_5_SILENCE_DEBOUNCE_SEL  ((u32)0x00000007 << 4)          /*!<R/W 3  Channel 5 ADC path silence detection debounce (48K) 3'b000: 80ms 3'b001: 160ms 3'b010: 320ms 3'b011: 640ms 3'b100: 1.28s 3'b101: 2.56s 3'b110: 5.12s 3'b111: 0.16ms */
...
#define AUD_MASK_ADC_6_SILENCE_DEBOUNCE_SEL  ((u32)0x00000007 << 4)          /*!<R/W 3  Channel 6 ADC path silence detection debounce (48K) 3'b000: 80ms 3'b001: 160ms 3'b010: 320ms 3'b011: 640ms 3'b100: 1.28s 3'b101: 2.56s 3'b110: 5.12s 3'b111: 0.16ms */
...
#define AUD_MASK_ADC_7_SILENCE_DEBOUNCE_SEL  ((u32)0x00000007 << 4)          /*!<R/W 3  Channel 7 ADC path silence detection debounce (48K) 3'b000: 80ms 3'b001: 160ms 3'b010: 320ms 3'b011: 640ms 3'b100: 1.28s 3'b101: 2.56s 3'b110: 5.12s 3'b111: 0.16ms */
...
#define AUD_MASK_DAC_L_SILENCE_DEBOUNCE_SEL  ((u32)0x00000007 << 4)          /*!<R/W 3  Channel L DAC path silence detection debounce (48K) 3'b000: 80ms 3'b001: 160ms 3'b010: 320ms 3'b011: 640ms 3'b100: 1.28s 3'b101: 2.56s 3'b110: 5.12s 3'b111: 0.16ms */
...
#define AUD_MASK_DAC_R_SILENCE_DEBOUNCE_SEL  ((u32)0x00000007 << 4)          /*!<R/W 3  Channel R DAC path silence detection debounce (48K) 3'b000: 80ms 3'b001: 160ms 3'b010: 320ms 3'b011: 640ms 3'b100: 1.28s 3'b101: 2.56s 3'b110: 5.12s 3'b111: 0.16ms */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ST_DS_L_BIQUAD_H0_0         ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  Sidetone downsample Lch EQ 0-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ST_DS_L_BIQUAD_H0_1         ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  Sidetone downsample Lch EQ 1-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ST_DS_L_BIQUAD_H0_2         ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  Sidetone downsample Lch EQ 2-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ST_DS_R_BIQUAD_H0_0         ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  Sidetone downsample Rch EQ 0-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ST_DS_R_BIQUAD_H0_1         ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  Sidetone downsample Rch EQ 1-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ST_DS_R_BIQUAD_H0_2         ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  Sidetone downsample Rch EQ 2-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_L_BIQUAD_H0_0           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Lch EQ 0-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_L_BIQUAD_H0_1           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Lch EQ 1-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_L_BIQUAD_H0_2           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Lch EQ 2-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_L_BIQUAD_H0_3           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Lch EQ 3-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_L_BIQUAD_H0_4           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Lch EQ 4-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_L_BIQUAD_H0_5           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Lch EQ 5-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_L_BIQUAD_H0_6           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Lch EQ 6-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_L_BIQUAD_H0_7           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Lch EQ 7-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_L_BIQUAD_H0_8           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Lch EQ 8-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_L_BIQUAD_H0_9           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Lch EQ 9-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_R_BIQUAD_H0_0           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Rch EQ 0-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_R_BIQUAD_H0_1           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Rch EQ 1-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_R_BIQUAD_H0_2           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Rch EQ 2-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_R_BIQUAD_H0_3           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Rch EQ 3-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_R_BIQUAD_H0_4           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Rch EQ 4-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_R_BIQUAD_H0_5           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Rch EQ 5-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_R_BIQUAD_H0_6           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Rch EQ 6-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_R_BIQUAD_H0_7           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Rch EQ 7-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_R_BIQUAD_H0_8           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Rch EQ 8-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_DAC_R_BIQUAD_H0_9           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  DAC Rch EQ 9-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_0_BIQUAD_H0_0           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 0 EQ 0-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_0_BIQUAD_H0_1           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 0 EQ 1-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_0_BIQUAD_H0_2           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 0 EQ 2-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_0_BIQUAD_H0_3           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 0 EQ 3-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_0_BIQUAD_H0_4           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 0 EQ 4-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_1_BIQUAD_H0_0           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 1 EQ 0-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_1_BIQUAD_H0_1           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 1 EQ 1-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_1_BIQUAD_H0_2           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 1 EQ 2-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_1_BIQUAD_H0_3           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 1 EQ 3-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_1_BIQUAD_H0_4           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 1 EQ 4-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_2_BIQUAD_H0_0           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 2 EQ 0-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_2_BIQUAD_H0_1           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 2 EQ 1-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_2_BIQUAD_H0_2           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 2 EQ 2-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_2_BIQUAD_H0_3           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 2 EQ 3-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_2_BIQUAD_H0_4           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 2 EQ 4-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_3_BIQUAD_H0_0           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 3 EQ 0-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_3_BIQUAD_H0_1           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 3 EQ 1-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_3_BIQUAD_H0_2           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 3 EQ 2-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_3_BIQUAD_H0_3           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 3 EQ 3-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_3_BIQUAD_H0_4           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 3 EQ 4-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_4_BIQUAD_H0_0           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 4 EQ 0-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_4_BIQUAD_H0_1           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 4 EQ 1-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_4_BIQUAD_H0_2           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 4 EQ 2-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_4_BIQUAD_H0_3           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 4 EQ 3-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_4_BIQUAD_H0_4           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 4 EQ 4-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_5_BIQUAD_H0_0           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 5 EQ 0-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_5_BIQUAD_H0_1           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 5 EQ 1-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_5_BIQUAD_H0_2           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 5 EQ 2-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_5_BIQUAD_H0_3           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 5 EQ 3-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_ADC_5_BIQUAD_H0_4           ((u32)0x1FFFFFFF << 0)          /*!<R/W 2000000  ADC channel 5 EQ 4-band coef. h0 2's complement in 4.25 format, i. e. the range is from -8~7.99. */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_VAD_VOICE_LEVEL             ((u32)0x000001FF << 0)          /*!<R/W 2c  The minimum value of mean power of PE&D unit0 */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_VAD_DET_THR                 ((u32)0x000000FF << 0)          /*!<R/W 19  Setting vad_flag threshold between frame power and mean power of PE&D unit0 */
 ...
 * @{
 *****************************************************************************/
#define AUD_MASK_VAD_DET_THR                 ((u32)0x000000FF << 0)          /*!<R/W 0  New enables of vad interrupts */
#define AUD_VAD_DET_THR(x)                   ((u32)(((x) & 0x000000FF) << 0))
#define AUD_GET_VAD_DET_THR(x)               ((u32)(((x >> 0) & 0x000000FF)))
/** @} */
...
typedef struct {
	u32 codec_sel_i2s_tx_word_len; 			/*!< Specifies the AUDIO CODEC TX Word length
										This parameter can be a value of @ref CODEC_word_len */

	u32 codec_sel_i2s_tx_ch_len;			/*!< Specifies the AUDIO SPORT TX Channel length
										This parameter can be a value of @ref CODEC_channel_len  */

	u32 codec_sel_i2s_tx_ch;				/*!< Specifies the AUDIO SPORT TX Channel L/R
										This parameter can be a value of @ref Codec_tx_channel  */

	u32 codec_sel_i2s_tx_data_format;		/*!< Specifies the AUDIO CODEC I2S RX selection of data fornat
										This parameter can be a value of @ref CODEC_data_format */

	u32 codec_sel_i2s_rx_word_len; 			/*!< Specifies the AUDIO CODEC RX Word length
										This parameter can be a value of @ref CODEC_word_len */

	u32 codec_sel_i2s_rx_ch_len;			/*!< Specifies the AUDIO SPORT RX Channel length
										This parameter can be a value of @ref CODEC_channel_len  */

	u32 codec_sel_i2s_rx_data_format;		/*!< Specifies the AUDIO CODEC I2S RX selection of data fornat
										This parameter can be a value of @ref CODEC_data_format */

	u32 codec_sel_rx_i2s_tdm;				/*!< Specifies the AUDIO CODEC Rx I2S TDM MODE
...
typedef struct {
	...
	u32 codec_sel_dac_i2s;				/*!< Specifies the AUDIO CODEC DAC path I2S sel
										This parameter can be a value of @ref CODEC_I2S_Channel */

	u32 codec_sel_dac_lin;				/*!< Specifies the AUDIO CODEC Channle L DAC path input sel
										This parameter can be a value of @ref DA_SRC_SEL */

	u32 codec_sel_dac_rin;				/*!< Specifies the AUDIO CODEC Channle R DAC path input sel
										This parameter can be a value of @ref DA_SRC_SEL */

	u32 codec_sel_adc_i2s;				/*!< Specifies the AUDIO CODEC ADC path I2S sel
										This parameter can be a value of @ref CODEC_I2S_Channel */

	u32 codec_application;				/*!< Specifies the AUDIO CODEC application
										This parameter can be a value of @ref codec_application */
...
/** @defgroup Codec_tx_channel_selection AUDIO CODEC Tx Channel Selection
  * @{
  */
...
/** @defgroup CODEC_I2S_Channel Selection
  * @{
  */
...
/** @defgroup AUDIO CODEC DAC path DA_SRC_SEL
  * @{
  */
#define I2S_L			((u32)0x00000000)
#define I2S_R			((u32)0x00000001)
#define I2S_LR			((u32)0x00000002)
#define TESTTONE		((u32)0x00000003)

#define IS_CODEC_DAC_SRC_SEL(SEL) (((SEL) == I2S_L) || \
							((SEL) == I2S_R) || \
							((SEL) == I2S_LR) || \
							((SEL) == TESTTONE))
...
#define MAX_VOLUME				0xaf

#define AD_CHANNEL_0			0
#define AD_CHANNEL_1			1
#define AD_CHANNEL_2			2
#define AD_CHANNEL_3			3
#define AD_CHANNEL_4			4
#define AD_CHANNEL_5			5
#define AD_CHANNEL_6			6
#define AD_CHANNEL_7			7

#define CODEC_ADC_X_AD_SRC_SEL(x, y) (AUD_ADC_##x##_AD_SRC_SEL(y))
#define AUD_BIT_ADC_X_AD_MIX_MUTE(x) (AUD_BIT_ADC_##x##_AD_MIX_MUTE)
#define AUD_MASK_ADC_X_AD_SRC_SEL(x) (AUD_MASK_ADC_##x##_AD_SRC_SEL)
#define CODEC_ADC_X_CONTROL_0(x)     (CODEC_ADC_##x##_CONTROL_0)
#define AUD_BIT_AD_X_EN(x)           (AUD_BIT_AD_##x##_EN)
#define AUD_BIT_AD_X_FIFO_EN(x)      (AUD_BIT_AD_##x##_FIFO_EN)
#define AUD_BIT_AD_ANA_X_EN(x)       (AUD_BIT_AD_ANA_##x##_EN)

#define DA_ZDET_TOUT_LEVEL0               3
#define DA_ZDET_TOUT_LEVEL1               0
#define DA_ZDET_TOUT_LEVEL2               1
#define DA_ZDET_TOUT_LEVEL3               2

#define DA_ZDET_FUNC_IMMEDIATE            0
#define DA_ZDET_FUNC_ZDET_AND_IMMEDIATE   1
#define DA_ZDET_FUNC_ZDET_AND_STEP        2
#define DA_ZDET_FUNC_ZDET_AND_TIMEOUT     3

/*define swr for audio here,if power has unified set, move it*/
...
#define APBPeriph_VAD                     ((u32)(1  << 30) | (0x00000001 << 26))  /*!<R/W 0  When VAD function enable , HS_SYSON_RAM domain must be on , for HSRAM memory at least in retention mode . 1: enable audio vad function 0: disable */
...
void audio_codec_sel_test_tone(bool NewState, u32 fc, void __iomem	* audio_base_addr);
