...
static void rtk_dma_clear_channel_interrupts(struct rtk_dma *rsdma, u32 channel_num)
{
...
static struct rtk_dma_txd *rtk_dma_find_unused_txd(struct rtk_dma_vchan *vchan)
{
...
static struct rtk_dma_txd *rtk_dma_find_vchan_txd(struct rtk_dma_vchan *vchan)
{
	struct rtk_dma_txd *txd = NULL;
	int cnt_txd;
...
static struct rtk_dma_txd *rtk_dma_find_vd_txd(struct virt_dma_desc *vd)
{
...
static void rtk_dma_remove(struct platform_device *pdev)
{
	int i;
