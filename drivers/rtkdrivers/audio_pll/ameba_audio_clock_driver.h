 ...
 * @{
 *****************************************************************************/
#define REG_LSYS_FEN_GRP0                            0x0008
#define REG_LSYS_FEN_GRP2                            0x0010
#define REG_LSYS_CKSL_GRP0                           0x0024
#define REG_LSYS_CKD_GRP1                            0x002C
#define REG_LSYS_CKD_GRP0                            0x0028
#define REG_LSYS_CKE_GRP2                            0x001C
#define REG_LSYS_SPORT_CLK                           0x004C

#define LSYS_CKE_SPORT(x)                        ((u32)(((x) & 0x0000000f) << 4))
#define LSYS_FEN_SPORT(x)                        ((u32)(((x) & 0x0000000f) << 8))
...
#define LSYS_MASK_CKD_PLFM                       ((u32)0x00000007 << 4)          /*!<R/WPD 1h  PLFM clock divider, it is based on np clock . 0: not valid 1: div2 2: div3 3/other: divider by this value + 1 */
#define LSYS_CKD_PLFM(x)                         ((u32)(((x) & 0x00000007) << 4))
#define LSYS_GET_CKD_PLFM(x)                     ((u32)(((x >> 4) & 0x00000007)))
#define LSYS_MASK_CKD_NP                         ((u32)0x00000007 << 0)          /*!<R/WPD 2h  NP clock divider, it is based on np pll (600M). 0: not valid 1: div2 2: div3 3/other: divider by this value + 1 */
...
#define REG_PLL_NPPLL_CTRL0                        0x000
#define REG_PLL_NPPLL_CTRL1                        0x004
#define REG_PLL_NPPLL_CTRL2                        0x008
#define REG_PLL_NPPLL_CTRL3                        0x00C
#define REG_PLL_I2SPLL1_CTRL0                      0x010
#define REG_PLL_I2SPLL1_CTRL1                      0x014
#define REG_PLL_I2SPLL1_CTRL2                      0x018
#define REG_PLL_I2SPLL1_CTRL3                      0x01C
#define REG_PLL_I2SPLL2_CTRL0                      0x020
#define REG_PLL_I2SPLL2_CTRL1                      0x024
#define REG_PLL_I2SPLL2_CTRL2                      0x028
#define REG_PLL_I2SPLL2_CTRL3                      0x02C
#define REG_PLL_TEST                               0x030
#define REG_PLL_PS                                 0x034
#define REG_PLL_AUX_BG                             0x038
...
typedef struct {
	...
	uint32_t PLL_NPPLL_CTRL1;                        /*!<  Register,  Address offset: 0x004 */
	uint32_t PLL_NPPLL_CTRL2;                        /*!<  Register,  Address offset: 0x008 */
	uint32_t PLL_NPPLL_CTRL3;                        /*!<  Register,  Address offset: 0x00C */
	uint32_t PLL_I2SPLL1_CTRL0;                      /*!<  Register,  Address offset: 0x010 */
	uint32_t PLL_I2SPLL1_CTRL1;                      /*!<  Register,  Address offset: 0x014 */
	uint32_t PLL_I2SPLL1_CTRL2;                      /*!<  Register,  Address offset: 0x018 */
	uint32_t PLL_I2SPLL1_CTRL3;                      /*!<  Register,  Address offset: 0x01C */
	uint32_t PLL_I2SPLL2_CTRL0;                      /*!<  Register,  Address offset: 0x020 */
	uint32_t PLL_I2SPLL2_CTRL1;                      /*!<  Register,  Address offset: 0x024 */
	uint32_t PLL_I2SPLL2_CTRL2;                      /*!<  Register,  Address offset: 0x028 */
	uint32_t PLL_I2SPLL2_CTRL3;                      /*!<  Register,  Address offset: 0x02C */
	uint32_t PLL_TEST;                               /*!<  Register,  Address offset: 0x030 */
	uint32_t PLL_PS;                                 /*!<  Register,  Address offset: 0x034 */
	uint32_t PLL_AUX_BG;                             /*!<  Register,  Address offset: 0x038 */
	uint32_t PLL_STATE;                              /*!<  Register,  Address offset: 0x03C */
} PLL_TypeDef;
