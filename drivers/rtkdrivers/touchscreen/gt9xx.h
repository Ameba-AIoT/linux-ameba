...
enum {
	GTP_DATA_TYPE_MUTUAL_RAW,
	GTP_DATA_TYPE_MUTUAL_DIFF,
	GTP_DATA_TYPE_MUTUAL_REF
};
...
#define GTP_RST_PORT    10 /* EXYNOS4_GPX2(0) */
#define GTP_INT_PORT    9 /* EXYNOS4_GPX2(1) */
...
/**************************PART3:OTHER define*******************************/
#define GTP_DRIVER_VERSION	"V2.8.5<2024-03-08>"
...
#define GTP_REG_MUTUAL_RAW_ADDR 0x8B98
#define GTP_REG_MUTUAL_REF_ADDR 0x81C0
#define GTP_REG_MUTUAL_DIFF_ADDR 0xBB10
...
extern void gtp_reset_guitar(struct i2c_client *client);
