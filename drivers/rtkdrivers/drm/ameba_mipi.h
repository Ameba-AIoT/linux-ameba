...
/* MANUAL_GEN_START */
#define MIPI_MAIN_CTRL_OFFSET		0x00
#define MIPI_CKLANE_CTRL_OFFSET	0x04
#define MIPI_LANE_CTRL_OFFSET  	0x08     
//RSVD0     			0xC     
#define MIPI_INTE_OFFSET         	0x10     
#define MIPI_INTS_OFFSET         	0x14     
#define MIPI_INTS_ACPU_OFFSET  	0x18     
//RSVD1     0x1C     
#define MIPI_RCMD_x_0_OFFSET		0x20//0x20-0x28 
#define MIPI_RCMD_x_1_OFFSET		0x24
#define MIPI_RCMD_x_2_OFFSET		0x28
//RSVD2[53]	0x2C-0xFC     
#define MIPI_TC0_OFFSET     		0x100     
#define MIPI_TC1_OFFSET     		0x104     
#define MIPI_TC2_OFFSET     		0x108     
#define MIPI_TC3_OFFSET     		0x10C     
#define MIPI_TC4_OFFSET     		0x110     
#define MIPI_TC5_OFFSET     		0x114     
//uint32_t RSVD3[58]	0x118-0x1FC     
#define MIPI_IDMA0_OFFSET         0x200     
#define MIPI_IDMA1_OFFSET         0x204     
#define MIPI_IDMA2_OFFSET         0x208     
//RSVD4[61]	0x20C-0x2FC     
#define MIPI_TO1_OFFSET     		0x300     
#define MIPI_TO2_OFFSET     		0x304     
#define MIPI_TO3_OFFSET     		0x308     
#define MIPI_TO4_OFFSET     		0x30C     
//RSVD5[60]	0x310-0x3FC     
#define MIPI_CMD_GO_OFFSET         0x400     
#define MIPI_CMD0_OFFSET         	0x404     
//RSVD6[62]	0x408-0x4FC     
#define MIPI_DPHY_STATUS0_OFFSET       0x500
#define MIPI_DPHY_STATUS1_OFFSET       0x504
#define MIPI_DPHY_ERR_OFFSET           0x508
//RSVD7[61]	0x50C-0x5FC     
#define MIPI_BIST_OFFSET           0x600     
//RSVD8[3]	0x604-0x60C     
#define MIPI_PAT_GEN_OFFSET        0x610     
//RSVD9[59]	0x614-0x6FC     
#define MIPI_DUMMY0_OFFSET         0x700     
#define MIPI_DUMMY1_OFFSET         0x704     
#define MIPI_DBG_OFFSET            0x708     
#define MIPI_CLK_DET0_OFFSET       0x70C     
#define MIPI_CLK_DET1_OFFSET       0x710     
#define MIPI_DBG_ST0_OFFSET        0x714     
#define MIPI_DBG_ST1_OFFSET        0x718     
#define MIPI_DBG_ST2_OFFSET        0x71C     
#define MIPI_DBG_ST3_OFFSET        0x720     
#define MIPI_DBG_ST4_OFFSET        0x724     
//RSVD10[54]	0x728-0x7FC     
#define MIPI_CLOCK_GEN_OFFSET           0x800     
#define MIPI_ESCAPE_TX_CLK_0_OFFSET     0x804     
#define MIPI_ESCAPE_TX_DATA_0_OFFSET     0x808     
#define MIPI_ESCAPE_TX_DATA_1_OFFSET     0x80C     
#define MIPI_ESCAPE_TX_DATA_2_OFFSET     0x810     
#define MIPI_ESCAPE_TX_DATA_3_OFFSET     0x814     
#define MIPI_ESCAPE_TX_DATA_4_OFFSET     0x818     
#define MIPI_ESCAPE_TX_DATA_5_OFFSET     0x81C     
#define MIPI_ESCAPE_TX_DATA_6_OFFSET     0x820     
#define MIPI_ESCAPE_RX_DATA_0_OFFSET     0x824     
#define MIPI_LANE_SWAP_CTRL_OFFSET     0x828     
#define MIPI_LANE_LP_BIST_0_OFFSET     0x82C     
#define MIPI_LANE_HS_BIST_OFFSET     	0x830     
#define MIPI_CONTENTION_DETECTOR_AND_STOPSTATE_DT_OFFSET     0x834     
#define MIPI_DEBUG_0_OFFSET        0x838     
#define MIPI_DEBUG_1_OFFSET        0x83C     
#define MIPI_SSC0_OFFSET           0x840     
#define MIPI_SSC1_OFFSET           0x844     
#define MIPI_SSC2_OFFSET           0x848     
#define MIPI_SSC3_OFFSET           0x84C     
#define MIPI_WATCHDOG_OFFSET  		0x850     
#define MIPI_RX_ESCAPE_READ_0_OFFSET     0x854     
#define MIPI_RX_ESCAPE_READ_1_OFFSET     0x858     
#define MIPI_DEGLITCH_LP_OFFSET	0x85C     
#define MIPI_LP_BIST_1_OFFSET  	0x860     
#define MIPI_LP_BIST_2_OFFSET  	0x864     
#define MIPI_LANE_PN_SWAP_1_OFFSET     0x868     
#define MIPI_LANE_PN_SWAP_2_OFFSET     0x86C     
//RSVD11[228] 0x870-0xBFC     
#define MIPI_MPLL_OFFSET           0xC00     
#define MIPI_LF_OFFSET             0xC04     
#define MIPI_TXF_OFFSET            0xC08     
#define MIPI_DF_OFFSET             0xC0C     
...
/** @defgroup MIPI_Exported_Functions MIPI Exported Functions
  * @{
  */
_LONG_CALL_ u32 MIPI_DSI_INTS_Get(void __iomem *MIPIx);
_LONG_CALL_ void MIPI_DSI_INTS_Clr(void __iomem *MIPIx, u32 DSI_INTS);
_LONG_CALL_ u32 MIPI_DSI_INTS_ACPU_Get(void __iomem *MIPIx);
_LONG_CALL_ void MIPI_DSI_INTS_ACPU_Clr(void __iomem *MIPIx, u32 DSI_INTS);
_LONG_CALL_ void MIPI_DSI_INT_Config(void __iomem *MIPIx, u8 AcpuEn, u8 ScpuEN, u8 IntSelAnS);

_LONG_CALL_ void MIPI_DSI_TO1_Set(void __iomem *MIPIx, u8 NewState, u32 TimeoutValue);
_LONG_CALL_ void MIPI_DSI_TO2_Set(void __iomem *MIPIx, u8 NewState, u32 TimeoutValue);
_LONG_CALL_ void MIPI_DSI_TO3_Set(void __iomem *MIPIx, u8 NewState, u32 TimeoutValue);

_LONG_CALL_ void MIPI_DSI_Main_Ctrl(void __iomem *MIPIx, MIPI_InitTypeDef *MIPI_InitStruct);
_LONG_CALL_ void MIPI_DSI_CMD_Send(void __iomem *MIPIx, u8 DataId, u8 Byte0, u8 Byte1);
