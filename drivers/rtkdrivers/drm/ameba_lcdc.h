...
#define LCDC_CTRL_OFFSET            0x000  
#define LCDC_PLANE_SIZE_OFFSET      0x004  
#define LCDC_UNDFLW_CFG_OFFSET      0x008  
#define LCDC_DMA_MODE_CFG_OFFSET    0x00C  
#define LCDC_SHW_RLD_CFG_OFFSET     0x010  
#define LCDC_BKG_COLOR_OFFSET       0x014  
#define LCDC_SEC_DEST_ADDR_OFFSET   0x018  
#define LCDC_DEBUG_STATUS_OFFSET    0x01C  
#define LCDC_IRQ_EN_OFFSET          0x020  
#define LCDC_IRQ_STATUS_OFFSET      0x024  
#define LCDC_IRQ_RAW_OFFSET         0x028  
#define LCDC_LINE_INT_POS_OFFSET    0x02C  
#define LCDC_CUR_POS_STATUS_OFFSET  0x030  
#define LCDC_STATUS_OFFSET          0x034  
//RSVD0[18]	0x38-0x7C
#define LCDC_LAYER1_BASEADDRESS_OFFSET  0x80
#define LCDC_LAYER2_BASEADDRESS_OFFSET  0xA0
#define LCDC_LAYER3_BASEADDRESS_OFFSET  0xC0
#define LCDC_LAYERx_CTRL_OFFSET         0x00
#define LCDC_LAYERx_BASE_ADDR_OFFSET    0x04
#define LCDC_LAYERx_WIN_XPOS_OFFSET     0x08
#define LCDC_LAYERx_WIN_YPOS_OFFSET     0x0C
#define LCDC_LAYERx_COLOR_KEY_OFFSET    0x10
#define LCDC_LAYERx_ALPHA_OFFSET        0x14
//RSVD[2];
...
/** @defgroup LCDC_DMA_Configure_functions LCDC DMA Configure Functions
  * @{
  */
_LONG_CALL_ void LCDC_DMAModeConfig(void __iomem *LCDCx, u32 BurstSize);
_LONG_CALL_ void LCDC_DMAUnderFlowConfig(void __iomem *LCDCx, u32 DmaUnFlwMode, u32 ErrorData);
_LONG_CALL_ void LCDC_DMADebugConfig(void __iomem *LCDCx, u32 DmaWriteBack, u32 ImgDestAddr);
/** @} */

/** @defgroup LCDC_Interrupt_functions LCDC Interrupt Functions
  * @{
  */
_LONG_CALL_ void LCDC_INTConfig(void __iomem *LCDCx, u32 LCDC_IT, u32 NewState);
_LONG_CALL_ void LCDC_LineINTPosConfig(void __iomem *LCDCx, u32 LineNum);
_LONG_CALL_ u32 LCDC_GetINTStatus(void __iomem *LCDCx);
_LONG_CALL_ u32 LCDC_GetRawINTStatus(void __iomem *LCDCx);
_LONG_CALL_ void LCDC_ClearAllINT(void __iomem *LCDCx);
_LONG_CALL_ void LCDC_ClearINT(void __iomem *LCDCx, u32 LCDC_IT);
_LONG_CALL_ void LCDC_GetCurPosStatus(void __iomem *LCDCx, u32 *pCurPosX, u32 *pCurPosY);
_LONG_CALL_ void LCDC_GetDmaUnINTCnt(void __iomem *LCDCx, u32 *DmaUnIntCnt);
/** @} */

/** @defgroup LCDC_global_functions LCDC Global Functions
  * @{
  */
_LONG_CALL_ void LCDC_Cmd(void __iomem *LCDCx, u32 NewState);
_LONG_CALL_ void LCDC_DeInit(void __iomem *LCDCx);
_LONG_CALL_ u8 LCDC_CheckLCDCReady(void __iomem *LCDCx);
_LONG_CALL_ void LCDC_SetPlaneSize(void __iomem *LCDCx, u32 ImageWidth, u32 ImageHeight);
_LONG_CALL_ void LCDC_SetBkgColor(void __iomem *LCDCx, u8 red_color, u8 green_color, u8 blue_color);
_LONG_CALL_ void LCDC_TrigerSHWReload(void __iomem *LCDCx);
_LONG_CALL_ void LCDC_LayerConfig(void __iomem *LCDCx, u8 LayerId, LCDC_LayerConfigTypeDef *EachLayer);
_LONG_CALL_ void LCDC_StructInit(LCDC_InitTypeDef *LCDC_InitStruct);
_LONG_CALL_ void LCDC_Init(void __iomem *LCDCx, LCDC_InitTypeDef *LCDC_InitStruct);
/** @} */
