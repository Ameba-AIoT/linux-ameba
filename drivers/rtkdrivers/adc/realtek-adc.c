...
/**
  ...
  *        - 1: Empty
  */
static u32 realtek_adc_readable(struct realtek_adc_data *adc)
{
...
static int realtek_adc_init_channel(struct iio_dev *indio_dev)
{
	...
	of_property_for_each_u32(node, "rtk,adc-channels", val) {
...
static void realtek_adc_remove(struct platform_device *pdev)
{
