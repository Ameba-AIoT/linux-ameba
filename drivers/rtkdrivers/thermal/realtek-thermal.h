...
#define TM_MASK_OSR               ((u32)0x00000007 << 11)          /*!<R/W 0x2  Deci filter DSR select * 0: 128 * 1: 256 * 2: 512 * 3: 1024 */
...
#define TM_BIT_EN_LATCH           ((u32)0x00000001 << 6)          /*!<R/W 0x1  Latch thermal sensor output immediately after power on for more accurate test */
...
#define TM_MASK_HIGH_WT_THR       ((u32)0x000001FF << 10)          /*!<R/W 0x069  Set the over temperature warning threshold for comparison with TEMP_OUT. * Bit18: Signed bit * Bit[17:10]: Integer part */
 ...
 * @{
 *****************************************************************************/
#define TM_BIT_MAX_CLR            ((u32)0x00000001 << 19)          /*!<R/W 0x0  This bit defines clear max temperature * 0: not clear * 1: clear tm_max value */
 ...
 * @{
 *****************************************************************************/
#define TM_BIT_MIN_CLR            ((u32)0x00000001 << 19)          /*!<R/W 0x0  This bit defines clear min temperature * 0: not clear * 1: clear tm_min value */
...
/* Registers for thermal */
#define RTK_TM_GAIN					0x00 /*!< THERMAL METER GAIN REGISTER */
#define RTK_TM_OFFSET				0x04 /*!< THERMAL METER OFFSET REGISTER */
#define RTK_TM_CTRL					0x08 /*!< THERMAL METER CONTROL REGISTER */
#define RTK_TM_TH_CTRL				0x0C /*!< THERMAL METER THRESHOLD CONTROL REGISTER */
#define RTK_TM_RESULT				0x10 /*!< THERMAL METER TEMPERATURE RESULT REGISTER */
#define RTK_TM_ADC_RESULT			0x14 /*!< THERMAL METER ADC RESULT REGISTER */
#define RTK_TM_MAX_CTRL				0x18 /*!< THERMAL METER MAX TEMPERATURE CONTROL REGISTER */
#define RTK_TM_MIN_CTRL				0x1C /*!< THERMAL METER MIN TEMPERATURE CONTROL REGISTER */
#define RTK_TM_OUT_PWR_ON			0x20 /*!< THERMAL METER POWER ON TEMPERATURE REGISTER */
#define RTK_TM_INTR_CTRL			0x24 /*!< THERMAL METER INTERRUPT CONTROL REGISTER */
#define RTK_TM_INTR_STS				0x28 /*!< THERMAL METER INTERRUPT STATUS REGISTER */
#define RTK_TM_TIMER				0x2C /*!< THERMAL METER TIMER REGISTER */
...
/* Thermal adc clock divider */
#define TM_ADC_CLK_DIV_256			((u8)0x00)
#define TM_ADC_CLK_DIV_128			((u8)0x01)
/**
 * struct realtek_thermal_info - thermal config data
 * @down_rate: thermal down sample rate
 * @clk_div: thermal clock divider
 * @low_tmp_th: low warning temperature threshold
 * @period: period of HW auto restart
 */
struct realtek_thermal_info {
	u8 down_rate;
	u8 clk_div;
	u16 low_tmp_th;
	u32 period;
...
/**
 * struct realtek_thermal_data - realtek thermal driver data
 * @dev: thermal device
 * @th_dev: thermal zone device
 * @mode: thermal mode
 * @base: control registers base cpu addr
 * @irq: interrupt for this adc instance
 * @temp_critical: critical temperature trip point
 * @temp_passive: passive temperature trip point
 * @num_trips: number of trip point
 * @lock: spinlock
 * @atim_clk: aon timer clock
 * @thm_clk: thermal clock
 */
struct realtek_thermal_data {
	struct device *dev;
